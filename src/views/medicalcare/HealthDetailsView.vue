...
const RecordAdmin = defineAsyncComponent(
  () => import("@/components/Record/RecordAdmin.vue")
);
const OutRecord = defineAsyncComponent(
  () => import("@/components/Record/OutRecord.vue")
);
